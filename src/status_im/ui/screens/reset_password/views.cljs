...
(defn input-field
  ...
  ([id errors on-submit focus?]
   [quo/text-input
    {:placeholder         (i18n/label (keyword :t id))
     :default-value       ""
     :auto-focus          focus?
...
(defview reset-password []
  (letsubs [form-vals [:multiaccount/reset-password-form-vals]
            errors [:multiaccount/reset-password-errors]
            next-enabled? [:multiaccount/reset-password-next-enabled?]]
